...
*	Retention Policy: Each partition enforces retention based on the topic-level retention policy, but the cleanup happens independently per partition. Retention policies can be based on time or size, allowing for flexible data retention strategies.
...
![image](https://github.com/jayachandradora/Kafka/assets/115500959/51798e88-56f6-450b-93e0-a31c7133ba9d)
